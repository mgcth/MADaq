function ts2uff(filen,TS)
% TS2UFF Writes time series data to UFF file. Uses writeuff for that purpose
%Inputs: filen - File name of UFF file
%        TS    - The time series data object to put on file
%Output: none
%Call:   ts2uff(filen,TS)
...
for I=1:ny
  ...
  DS{N}.measData=squeeze(TS.Data(:,I));
  DS{N}.x=TS.Time;
  DS{N}.d1=D1;
  DS{N}.d2=D2;
  DS{N}.date=DATE;
