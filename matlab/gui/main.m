...
% Last Modified by GUIDE v2.5 06-Mar-2015 10:09:25
...
elseif handles.periodic.Value == 1 % if impactTest
    ...
    periodic.session.DurationInSeconds = str2double(get(handles.durationTime, 'String'));
...
function fun1Edit_Callback(hObject, eventdata, handles)
% hObject    handle to fun1Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of fun1Edit as text
%        str2double(get(hObject,'String')) returns contents of fun1Edit as a double


% --- Executes during object creation, after setting all properties.
function fun1Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to fun1Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function fun2Edit_Callback(hObject, eventdata, handles)
% hObject    handle to fun2Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of fun2Edit as text
%        str2double(get(hObject,'String')) returns contents of fun2Edit as a double


% --- Executes during object creation, after setting all properties.
function fun2Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to fun2Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function fun3Edit_Callback(hObject, eventdata, handles)
% hObject    handle to fun3Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of fun3Edit as text
%        str2double(get(hObject,'String')) returns contents of fun3Edit as a double


% --- Executes during object creation, after setting all properties.
function fun3Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to fun3Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function fun4Edit_Callback(hObject, eventdata, handles)
% hObject    handle to fun4Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of fun4Edit as text
%        str2double(get(hObject,'String')) returns contents of fun4Edit as a double


% --- Executes during object creation, after setting all properties.
function fun4Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to fun4Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function fun5Edit_Callback(hObject, eventdata, handles)
% hObject    handle to fun5Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of fun5Edit as text
%        str2double(get(hObject,'String')) returns contents of fun5Edit as a double


% --- Executes during object creation, after setting all properties.
function fun5Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to fun5Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function fun6Edit_Callback(hObject, eventdata, handles)
% hObject    handle to fun6Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of fun6Edit as text
%        str2double(get(hObject,'String')) returns contents of fun6Edit as a double


% --- Executes during object creation, after setting all properties.
function fun6Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to fun6Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function fun7Edit_Callback(hObject, eventdata, handles)
% hObject    handle to fun7Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of fun7Edit as text
%        str2double(get(hObject,'String')) returns contents of fun7Edit as a double


% --- Executes during object creation, after setting all properties.
function fun7Edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to fun7Edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
