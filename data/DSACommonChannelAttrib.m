        ...
        function set.EnhancedAliasRejectionEnable(obj,value)
            try
                ...
                if isempty(value) || ~isscalar(value) ||...
                    ...
                    error(message(...
                    'daq:ni:EnhancedAliasRejectionEnableMustBeLogical'));
                end
...
%                     % call message catalog directly.
%                     error(message(...
%                         'daq:ni:EnhancedAliasRejectionEnableReadOnlyWhenAutoSyncDSA'));
%                     
%                 end
    ...
    methods (Access = protected)
        function DSAPropertyBeingChangedHook(obj,propertyName,newValue,session)
            ...
            try
                ...
                switch e.identifier
                    case {'daq:ni:err200077','daq:ni:err200452'}
                        % Cannot derive from daq.internal.BaseClass, so
                        % call message catalog directly.
                        error(message('daq:ni:deviceDoesNotSupport',propertyName,newValueChar))
                    otherwise
                        rethrow(e)
                end
            end
